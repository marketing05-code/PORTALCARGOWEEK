...
const CW_HEADERS = ["Fecha", "Nombre", "Sucursal", "Fase", "Tiempo", "Juego"];
...
function getRanking_(fase) {
  ...
  for(let r=1;r<vals.length;r++){
    ...
    const t=cell_(row,idx,"tiempo"); const valor=parseTimeMs_(t); const detalle=String(t||"");
