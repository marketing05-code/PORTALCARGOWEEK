...
const CW_HEADERS = ["Fecha", "Nombre", "Sucursal", "Fase", "Puntos", "Juego"];
...
function getRanking_(fase) {
  ...
  for(let r=1;r<vals.length;r++){
    ...
    const valor=Number(cell_(row,idx,"puntos"))||0; const detalle=valor+" cajas";
